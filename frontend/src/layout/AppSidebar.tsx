...
import CS222Logo from "../assets/CS222Logo.png";
    ...
    >
      ...
      >
        <Link to="/" className="lg:hidden">
          <img src={CS222Logo} alt="Space Hub" className="h-8 w-auto" />
        </Link>
        <Link to="/">
          {isExpanded || isHovered || isMobileOpen ? (
            <img
      ...
      {/* Copyright moved into SidebarWidget to keep it stationary under the Space Hub text */}
    </aside>
  );
};
