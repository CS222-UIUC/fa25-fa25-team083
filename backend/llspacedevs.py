...
class AstronautData:
    ...
    def __init__(self, cache_file="astronauts.json", base_url="https://lldev.thespacedevs.com/2.2.0/astronaut/"):
    ...
    def get_astronauts_by_country(self, country_name):
       ...
       Takes in country name and returns list of astronauts from that country
        ...
        filtered = [
            a["name"]
            for a in astronauts
            if a.get("nationality") and country_name.lower() in a.get("nationality", "").lower()
        ]
